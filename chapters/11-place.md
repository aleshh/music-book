...
broader practice of embodied and inclusive attention.[^1]
...
A room can do this without being an artist. The cistern did not listen, choose,
...
announcements arriving from distant speakers.

You can also hear a social place. People are traveling, waiting, working,
meeting, sleeping, hurrying, and trying to understand those announcements.
Their attention is not available on demand.

There is a historical place: the station's architecture, labor, policing,
access, neighborhood, and the journeys it has enabled or prevented.

There is an environmental place: weather entering through doors, trains,
brakes, birds, traffic, luggage, phones, and the shifting density of bodies.

There is a personal place: one listener associates the platform with daily
fatigue, another with departure, another with a language they do not speak.

A site-responsive composition need not explain all of these. It should know
...
Every room gives an action a different afterlife. In a dry studio, short
attacks remain distinct. In a stone church, they overlap and may form harmonies
the score did not space deliberately. Outdoors, reflections may be weak while
distance, wind, and direction become more important.

Three compositional decisions follow.

First, decide the **rate at which the room can forget**. If a resonance remains
for eight seconds, an attack every two seconds creates accumulation even when
each player performs a single line. If the room returns almost nothing, the
...
it. A short sound can give the room more to do.
...
A **site-specific work** depends on one place so substantially that moving it
changes or destroys its identity. Its distances, history, paths, objects, or
...
percussionists and is designed for forces ranging from nine to ninety-nine.
Performers disperse through the location. Listeners are free to move among
them.[^2]
...
sounds to enter awareness. Those sounds are not printed as charming extras.
They differ with every realization, and the scored form leaves a scale of
opening in which they can become perceptible.[^3]

The title requires care. Inuksuit are culturally specific stone constructions
...
As an **object**, it asks to be attended to as a bounded work. The place houses
the encounter, even when its acoustics alter it.

As a **frame**, it redirects attention toward sounds and activities already
present. Cage's *4'33"* is an unusually clear instance: the articulated
...
If it may become foreground occasionally, decide what calls attention and how
the piece releases it. If listeners need to hear a formal return, do not hide
...
Music can **support** activity by supplying continuity, scale, pacing, or
privacy. It can make a large room feel less exposed or give a repeated task a
...
conversation fills a long decay, machinery establishes a rate the performers
do not imitate.

It can **mark** activity by sounding transitions, gathering people, or giving
an ending to an event larger than the music.

It can also obstruct. A narrow frequency band masks speech. A low pulse makes
concentration difficult. A performance blocks circulation. A duration outlasts
...
series of strongly contrasting musical sections. Site-responsiveness can
produce difference rather than resemblance.
...
religious association, and formal contrast into relation with the site. The
question is whether the room changes how those materials are spaced, balanced,
and heard.

Feldman's work can be performed elsewhere, and often is. Its relation to the
chapel remains part of its design without requiring every performance to
...
credited to human intrusion. The landscape has been turned into cover art.

Instead, identify actual relations. Reserve a register where local insects are
active. Let wind determine whether a cue can travel. Build a piece that changes
when traffic density rises. Acknowledge the land's names, uses, and custodians.
If the work depends on weather, decide what happens when weather refuses the
premise.
...
This does not prohibit public music. It changes the responsibilities.

Consider **volume** not only as expression but as reach. Who will hear the work
inside nearby homes, offices, classrooms, or habitats? A sound may be safe near
its source and exhausting through repeated exposure.

Consider **duration** as occupation. A ten-minute event and an eight-hour field
make different claims on workers and residents even at the same level.

Consider **exit**. Can people leave physically? Can they reach quieter zones?
Can a worker assigned to the site opt out? An invitation to wander is not an
exit if every path remains inside the sound.

Consider **access**. Uneven terrain, darkness, standing duration, low-frequency
intensity, flashing cues, and unclear paths distribute the piece differently
among bodies.

Consider **communication**. If ordinary activity may continue, say so. If a
quiet passage requires silence, do not punish a public that was told the music
...
on average every few minutes. One corner returns low frequencies; another
absorbs speech.

Map positions. Where are sources, listeners, paths, obstacles, quiet zones, and
exits? Walk the route at the pace actual visitors use.

Identify activities. Who works, waits, rests, passes, performs, supervises, and
cannot leave? Ask what the piece may ask of them.

Choose one relation with the site. The room may determine spacing, the public
may determine recoverability, surrounding sound may cue change, or history may
govern material. Do not call everything collaboration.

Define the work's invariant. If weather and audience path vary, what remains
recognizable: a large trajectory, interval family, spatial pattern, behavior,
or recurring signal?
...
Choose one site and listen for fifteen minutes. Do not collect poetic
descriptions. Make four lists: cycles, distances, masking relations, and social
activities.

Select one potential first sound. Predict what it would mask, attract, support,
or interrupt. Then make it once.

Listen for another five minutes. Did the sound reveal the place or replace it?
Did its decay belong to the site? Did anyone's behavior change?

Do not add a second sound until you can describe what the first one did.

### 2. One Score, Three Places
...
Perform it in three unlike places: dry and resonant, private and public, narrow
and open, or quiet and active.

Do not revise only dynamics. Ask whether the site's response changes form. If
the work remains identical except for volume, admit that it is portable rather
than site-determined. Portability is an answer.

### 3. The Publicness Audit

Design a thirty-minute work for a shared space. Draw a map showing sources,
reach, quiet zones, routes, and exits.

List the people likely to encounter it. Mark who chose the performance, who is
working, who can leave, and who may need access you have not considered.

Create two failure conditions: the public remains louder than the music, and a
local sound occupies the work's central register. Write a musical response to
each that preserves identity without demanding obedience.

Ask someone who uses the site but is not part of the ensemble to review the
...
[^1]: Pauline Oliveros, “The Music of the Environmental Dialogue,”
    <https://www.econtact.ca/17_3/oliveros_music.html>; Rensselaer Polytechnic
    Institute, history of Deep Listening,
    <https://news.rpi.edu/luwakkey/3027>; IRCAM, Pauline Oliveros work survey,
    <https://ressources.ircam.fr/en/composer/pauline-oliveros/workcourse>.
    Oliveros's first-person account gives the roughly fourteen-foot depth and
    forty-five-second reverberation; the institutional sources corroborate the
    1988 session and personnel.

[^2]: John Luther Adams and Steven Schick, Banff premiere interview,
    <https://www.johnlutheradams.net/interviews/7>; John Luther Adams,
    interview on site-determined music,
    <https://www.johnlutheradams.net/interviews/8>; Wise Music Classical,
    “Music Without Walls,”
    <https://www.wisemusicclassical.com/features/2020/06/john-luther-adams-music-without-walls/>.
    These sources document the June 21, 2009 premiere by eighteen
    percussionists, the nine-to-ninety-nine range, dispersal, mobile audience,
    and Adams's site-determined distinction.

[^3]: The Adams-Schick premiere interview describes wind and animals becoming
    newly audible within the score's openings. It also gives Adams's account of
    the title. That account is evidence for his intention, not a definition of
    the varied historical functions or cultural meanings of Inuit-built
    inuksuit.

[^4]: IRCAM, *The Rothko Chapel* work record and Feldman programme note,
    <https://ressources.ircam.fr/en/work/the-rothko-chapel>; Rothko Chapel,
    performance history,
    <https://rothkochapel.org/index.php/experience/events/event/morton-feldmans-rothko-chapel>.
    The sources document the 1971 commission, April 9, 1972 premiere, and
    forces.

[^5]: Morton Feldman's programme note is reproduced in IRCAM's 2017 festival
    programme,
    <https://www.ircam.fr/media/uploads/creation/etincelle/etincelle_17_-_manifeste_2017.pdf>.
    Feldman identifies the chapel's role in instrumentation, balance, timbre,
    and close spatial effect, as well as the youthful viola melody,
    Stravinsky-funeral soprano line, and synagogue associations.
