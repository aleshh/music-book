...
progression: one chord creates a need that another satisfies. It can also
establish a region in which pitches have different degrees of attraction,
friction, stability, and distance without continually leaving that region.
A bass note can remain while its meaning changes. An inner voice can move
while the chord name stays put. A mode can acquire a center through emphasis
rather than cadence. Two centers can remain plausible at once.
...
As an inventory, they are neutral. We can arrange them as a rising scale,
spread them across six octaves, repeat one while the others pass quickly, or
place them above several different bass notes. The collection tells us what is
...
inventory may lean toward C. Place A below everything, prolong C and E above
it, and D may become an inflection around an A-minor field. No pitch has been
added or removed. Gravity has been reassigned.

This is the difference between a **collection** and a **harmonic field**. A
collection is a set of available pitches. A field is a collection whose
members have acquired characteristic weights and relationships. Those weights
need not form a single hierarchy, but they must arise from evidence.
...
D as a center while allowing the third to appear and disappear. These are
different worlds hiding beneath one label.
...
available as each relation changes. Yet duration alone is not enough. A
prolonged pitch that never affects spacing, phrasing, or interval character may
be an acoustic fact without becoming harmonic ground.
...
arrives mainly against D, its whole-step friction may become more important
than any chord name. A pitch is partly the history of the intervals in which
we have met it.
...
gives the field perspective. We hear other pitches as being above it, away
from it, briefly joined to it, or returning to a texture it has continued to
anchor.
...
The whole-tone collection is not a gamelan tuning, and Debussy's piano is not a
Javanese ensemble in disguise. What the 1889 encounter can responsibly show is
that another musical practice helped make European harmonic inevitabilities
feel contingent. The later composition remains the result of many encounters,
studies, habits, and decisions.
...
of friction, a registral floor, or a memory of an earlier center? If the answer
never changes, the pedal may still work, but its form must come from somewhere
else.
...
vertical summaries and conceal the paths by which one sound becomes another.

Those paths are **voice-leading**.

Move from D–F–A to D–G–B-flat. A chord label reports D minor followed by G
minor over D. The ear also hears something more immediate: D remains, F rises
to G, and A rises by semitone to B-flat. One common tone stabilizes the change;
two directed motions color it.
...
across them, register may become the principal event. If the line returns to
its starting pitch after several different spacings, the return can be heard
as harmonic even though the chord name is unchanged.
...
at a time. Ascending and descending spans alternate. Each leaves and returns
to A.[^3]
...
voice. A note that belongs completely to F major can still feel exposed when
...
audible relations from E–G–C compressed in one octave. The first exposes a
fifth beneath a tenth; the second places two thirds in close succession. The
...
whole-number frequency relationships. An octave may relate as 2:1, a perfect
fifth as 3:2, and a major third as 5:4. In twelve-tone equal temperament, the
octave is divided into twelve equal steps, allowing convenient transposition
and modulation while making most intervals slight compromises from those
simple ratios.

Neither system is morally pure. They solve different musical problems.
...
with the next strike, and a range the builders chose. The harmonic world is not
separable from the bodies that sound it.

Harrison and Colvig called the ensemble an American gamelan. The adjective is
...
different registral shape. Preserve A as a melodic point common to both. The
listener may feel the center tilt rather than flip.
...
local meaning. Restriction may prevent wrong notes while also preventing
necessary ones.

The second is **automatic spaciousness**. Open fifths, added seconds, and wide
triads have acquired a ready-made association with ambient breadth. They can
create breadth, but register alone does not tell us why this fifth returns,
...
The path should change a relation, not merely keep the surface occupied.

Define what departure means. In progression-based harmony, departure may be a
move away from tonic. In a field, it might be distance from a registral center,
loss of a characteristic interval, transfer of the bass, increased beating, or
the temporary strengthening of another center.
...
In the first, establish a center through bass and duration. In the second, use
no sustained bass; establish another center through phrase endings and
recurrence. In the third, let register alone give a pitch unusual weight.

Keep tempo, instrumentation, and general density comparable. The point is to
hear three kinds of gravity rather than three contrasting moods.

Afterward, identify the smallest piece of evidence that made each center
...
Begin with a close middle-register voicing. Over several stages, create a sense
of departure using only octave transfer, doubling, and the reassignment of the
bass. Then create a return without restoring the opening voicing exactly.

Let one voice move at a time in the first version. In a second version, let the
outer voices move in contrary motion while the inner pitches remain. Compare
which path makes the harmonic transformation easier to remember.
...
important common tone.

Write or improvise three sections. The first favors one center without
eliminating the other. The second tilts the evidence. The third allows both
hearings to remain active.

If working with an ensemble, assign the bass and melody to different players.
Let each control the timing of the evidence for one center while listening for
the other. The harmony should remain coherent even when the moment of tilt is
not fixed.
...
[^1]: Debussy's attendance at the 1889 Paris Exposition and his later writing
    about Javanese music are documented and contextualized in *Debussy's Paris:
    Piano Portraits of the Belle Époque*, Oxford University Press,
    <https://academic.oup.com/book/56282/chapter-abstract/445227930>, and Ralph
    P. Locke, “A Broader View of Musical Exoticism,” which reproduces the
...
[^2]: Claude Debussy, *Préludes*, Book I, no. 2, “Voiles,” Durand, 1910,
    score at
    <https://s9.imslp.org/files/imglnks/usimg/2/24/IMSLP406068-PMLP02394-No.2_Voiles.pdf>;
    David J. Code, “Parting the Veils of Debussy's ‘Voiles,’” *Scottish Music
    Review* 1, no. 1 (2007), <https://eprints.gla.ac.uk/7496/>. Studies of the
    first book's pitch organization corroborate the whole-tone outer field,
    brief pentatonic region, localized exceptions, and structural low B-flat:
    <https://researchspace.ukzn.ac.za/bitstreams/dee4389f-0725-44fe-87aa-78ef5a154af3/download>
    and
    <https://research-information.bris.ac.uk/ws/portalfiles/portal/34496856/386226.pdf>.

[^3]: Arvo Pärt Centre, *Spiegel im Spiegel* work page,
    <https://www.arvopart.ee/en/arvo-part/work/545/>. The Centre documents the
    1978 commission, expanding mirrored phrases, return to A, and fixed
    tintinnabuli relation. Andrew Shenton's analysis identifies the F-major
    triadic field and the distinction between F as harmonic root and A as
    melodic center: <https://www.mdpi.com/2077-1444/5/2/361>.

[^4]: Other Minds, programme for William Colvig and the American gamelan,
    <https://www.otherminds.org/wp-content/uploads/2017/08/om22program_lorez.pdf>;
    Lou Harrison, American Mavericks interview,
    <https://musicmavericks.publicradio.org/features/interview_harrison.html>;
    Brady Spitz, *Lou Harrison's “Old Granddad”: A Composer's Guide*, Rice
    University, <https://repository.rice.edu/items/258b58a7-bc6c-4374-b9d8-42cafb43aa20>.
    These sources document the 1971 collaboration, materials, resonators, and
    the distinct labor of Harrison and Colvig.
