...
The loss should not be romanticized as the open form's final triumph. A Black,
gay composer's incomplete archive is not proof that music is better when
...
**Material control** concerns which pitches, rhythms, gestures, words, or
sound-actions may appear.

**Temporal control** concerns onset, duration, pulse, sequence, repetition, and
sectional change.

**Relational control** concerns how one part depends on another: respond,
imitate, avoid, align, support, interrupt.

**Interpretive control** concerns touch, articulation, phrasing, dynamics,
tone, and the scale of expressive variation.

**Formal control** concerns order, proportion, transition, continuation, and
ending.

**Contextual control** concerns site, audience behavior, surrounding sound,
and circumstances that no performer owns completely.
...
A conventional note says that the composer selects a pitch and approximate
duration; the performer supplies an instrument, attack, tuning, color, and
placement in a living phrase. More notation can narrow those choices. It
cannot eliminate performance. Less notation does not remove the decisions. It
moves them.

Several broad kinds of notation make different movements visible.

**Result notation** describes a desired audible event: play middle C softly
for four beats. It specifies what should happen more than how the performer
should produce it.

**Action notation** prescribes behavior: draw the bow from fingerboard toward
bridge while allowing pitch to break. The exact spectrum is a consequence of
the action, instrument, and player.

**Relational notation** makes one event depend on another: enter after the
longest sound you can still hear; choose a pitch not currently present; stop
when two other players align. Its unit is interaction.

**Attention notation** tells a performer what to notice: listen for the room's
decay, follow the least audible player, or maintain the boundary between your
sound and the surrounding noise. The resulting notes may remain open while the
quality of listening is exact.
...
The answer may reside in **material**. A theme, pitch collection, text, or
gesture must remain.

It may reside in **behavior**. Materials can change, but processes of echoing,
accumulating, or exchanging roles identify the piece.

It may reside in **relation**. Players may use any sounds so long as each
action answers, obstructs, or sustains another in a particular way.

It may reside in **form**. Sections can vary internally while their order,
proportion, or mode of transition remains.

It may reside in **practice**. The work is carried through particular people,
rehearsal methods, stories, recordings, and ethical commitments that no single
page contains.
...
score that says “make any sound for any duration” may produce an experience,
but its identity cannot be defended by insisting that every conceivable
...
performance. It changes how the score was made, not necessarily what a player
may choose.

Performance indeterminacy does the reverse. A composer may choose every
available option carefully, then allow the performer to select among them,
order them, or determine their timing. Chance need not enter at all.

Improvisation asks a person to make musical decisions in real time. Those
decisions may use preparation, idiom, memory, technique, and interaction. An
improviser is not a random device with good reflexes.
...
network of timing whose details emerge in performance. The score composes the
conditions of that network.
...
It may mean develop material in a known idiom. It may mean choose among a
composed vocabulary. It may mean respond freely to other performers while
preserving a work's density or harmonic field. It may mean bring one's own
practice into a meeting whose result no participant can predict.
...
or choose a transition whose timing depends on the actual room. Give them a
...
then translate the score back into sound, often using knowledge of the tapes to
question the notation. Composition travels through a chain of agencies.
...
a rehearsal recorded and released. They may accept the risk of failure while
expecting the composer to provide a recovery procedure.

Open scores can intensify unequal power. A famous composer may invite
performers to “take risks” while retaining sole credit if the result succeeds
and attributing failure to their choices. Freedom offered under those terms is
an insurance policy.

Ask before rehearsal: who carries artistic risk, who carries bodily risk, who
receives recognition, and who can refuse?
...
An **error** violates an essential condition and should be corrected if
possible.

A **tolerance** permits variation within a range. An entrance may occur within
one breath of a cue; a pitch may bend while preserving its function.

A **mutation** changes the system but remains musically usable. The ensemble
accepts a mistaken pitch as a new center or treats a missed cue as permission
to extend the section.

A **recovery action** restores shared knowledge. Return to the main theme,
sound a designated interval, clear the texture, or allow one player to reset
the sequence.
...
whether the performers have agreed to make them.

Another failure is option without consequence. Players may choose any of ten
...
Choose the reason for openness. Is it needed because performers can respond to
the room, because the ensemble changes size, because timing must arise from
listening, because surprise is part of the form, or because the work should
survive varied communities? “I like openness” is a preference, not yet a
design.

Assign each variable. Composer, individual performer, ensemble, chance
procedure, instrument, audience, and environment are different agents. Give a
decision to the one capable of hearing its consequence.

Define the available choices. A boundary can be material, relational, temporal,
or contextual. Make the range wide enough to matter and narrow enough that its
outcomes still belong.
...
Plan cues and recovery. Decide who may change the state, how others recognize
the change, and what happens when recognition fails.

Agree on credit and consent before the piece depends on unpaid invention. An
open process does not make these conversations premature. It makes them part
...
For each, write who actually decides: composer, performer, ensemble, chance,
instrument, or context. Do not write “shared” until you can describe how the
sharing occurs.
...
Make three notations.

In the first, specify every pitch, rhythm, and transition.

In the second, provide fixed materials and let performers choose repetitions,
order, and cue timing.

In the third, describe only relational behavior: who gathers, who rises, what
counts as being left alone.

Perform all three with the same musicians. Ask what remained recognizable,
which version produced meaningful listening, and where performers had to
compose information you omitted.
...
In the first version, the composer fixes pitch, performers determine duration
through interaction, and a chance process selects articulation. In the second,
...
life is distributed and therefore more demanding.

Releasing control means trusting another agent with a real decision and
remaining accountable for the conditions of that trust. Performers are the
closest partners, but they are not the last. The room returns sound. A site
permits some movements and prevents others. A public may listen, leave, talk,
...
[^1]: Wise Music Classical, *Stay On It* official work page and performance
    notes, <https://www.wisemusicclassical.com/work/57872/Stay-On-It--Julius-Eastman/>;
    Matthew Mendez, “That Piece Does Not Exist without Julius: Still Staying
    on *Stay On It*,” in *Gay Guerrilla: Julius Eastman and His Music*,
    <https://www.cambridge.org/core/books/abs/gay-guerrilla/that-piece-does-not-exist-without-julius-still-staying-on-stay-on-it/EDCEE9937AABE734351B1F414FFB2E57>;
    Tom Huizenga, “Wild Up, ‘Stay On It,’” NPR/WRTI, May 18, 2022,
    <https://www.wrti.org/latest-classical-from-npr-music/latest-classical-from-npr-music/2022-05-18/wild-up-stay-on-it>.
    The sources distinguish Eastman's historically open practice from later
    editorial reconstruction.

[^2]: Wise Music's current performance notes specify open instrumentation,
    recurring themes, optional cells and improvisation, and visual or musical
    cues. Mary Jane Leach's Eastman archive documents the surviving score
    situation: <https://www.mjleach.com/EastmanScores.htm>. A modern edition is
    recoverable scholarship and a new mediation, not a final manuscript found
    intact.

[^3]: John Cage Complete Works, *Music of Changes* work record,
    <https://www.data-johncage.org/pp/John-Cage-Work-Detail.cfm?work_ID=134>;
    James Pritchett's research on Cage's chance procedures,
...
[^4]: Christian Wolff, BOMB interview, April 1, 1997,
    ...
    *A Celebration of Christian Wolff*,
    <https://eamusic.dartmouth.edu/~larry/miscellaneous_archival_documents/programs/Wolff_FINAL.pdf>;
    Philip Thomas, “Understanding Wolff through Music,” *Circuit* 30, no. 2,
    <https://www.erudit.org/fr/revues/circuit/2020-v30-n2-circuit05461/1071119ar.pdf>.
    These sources document open instrumentation and selection alongside exact
    responsive constraints.

[^5]: Marco Fusi, “Fingers to Sounds, Sounds to Fingers,” *Archival Notes* 7,
    <https://onlinepublishing.cini.it/index.php/arno/article/view/202>;
    Fondazione Isabella Scelsi, archive description,
    <https://www.scelsi.it/it/fondo-giacinto-scelsi/>. The archive preserves
    roughly 730 tapes, while Fusi's research describes improvisation,
    recording, assistant transcription, and its interpretive consequences.

[^6]: Frances-Marie Uitti, “Preserving the Scelsi Improvisations,” *Tempo*,
    <https://www.cambridge.org/core/services/aop-cambridge-core/content/view/F27DBB92D3516449BD0ACABBA0591AEC/S0040298200004484a.pdf/preserving_the_scelsi_improvisations.pdf>;
