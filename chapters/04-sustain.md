...
sound cannot be held in place the way a paperweight holds a page. Energy is
supplied, transferred, reflected, absorbed, and lost. A singer renews air. A
bow changes direction. A piano string begins decaying the moment it is struck.
A room returns some frequencies more readily than others. Two players who
believe they are holding the same pitch produce slow fluctuations because they
are not producing the same frequency at every instant.
...
All three events may last ten seconds. They do not continue in the same way.

The violinist supplies **continuous energy**. The bow keeps the string in
motion, although pressure, speed, contact point, and bow direction change. The
...
source remains continuous; the identity does. This can become a question of
...
The **attack** establishes the action and often supplies a wide burst of
frequencies. The **bloom** is the interval in which the instrument, room, or
ensemble settles into fuller resonance. The **continuation** is whatever
behavior maintains identity after the beginning. The **release** is the change
created when active energy stops or a sustaining mechanism is removed. The
**decay** is the remaining loss and redistribution of energy. **Aftersound** is
what continues to matter after the action: physical resonance, sympathetic
...
This is rhythm produced by relation rather than attack.

The simple arithmetic is a model, not a complete description of two
instrumental sounds. Each source contains several components. Vibrato moves
them. Bow pressure and breath alter their strengths. The room changes their
balance by position. Two nominally steady players constantly make small
corrections, so the beat rate may waver, split, or become rough rather than
...
the fluctuation is about as fast as a relaxed walking pulse, then slow it until
the swells nearly separate” gives the ear a relation to find. Exact frequency
numbers may be useful in one piece and unnecessary in another. The audible
...
This allows Scelsi to separate identity from exact sameness. A brass-weighted
surge and a thin, wavering sonority can belong to the same pitch center while
occupying different physical and expressive states. An inflection away from
the center does not necessarily become a melodic departure. It can make the
center thicker by exposing its border. Returning to the nominal pitch after a
microtonal deviation feels less like coming home from another key than like
...
A **drone** establishes a continuing sonic field. It may consist of one pitch,
an interval, a spectrum, or a recurring band of sound. Other events are heard
inside or against it. A drone can be high, intermittent, abrasive, unstable,
or louder than everything around it. Low continuous tones are common because
they provide weight and leave upper register available, not because lowness is
...
collaborations and studies, including the Theatre of Eternal Music, the sound
and light environments made with Marian Zazeela, and Young's long discipleship
with Pandit Pran Nath. To call all of this “drone music” can be descriptively
...
The process was first performed in 1969.[^8]

The mechanism can be stated in one sentence. Its musical consequence takes
longer to hear.
...
Decide whether renewals should be concealed, admitted, or made formal. A bow
change can disappear inside stable pressure, or it can create a soft hinge. A
breath can divide phrases, or several performers can stagger breathing so the
ensemble field continues. A tremolo can simulate sustain while making the rate
of renewal audible. Rearticulation can preserve pitch while turning continuity
into ritual return.
...
an excellent publicist. Internal life does not require constant animation. It
requires a stable enough reference that some motion can be heard as motion.
...
instrumental unison may feel agitated even at an unchanging dynamic. Volume,
frequency, duration, room, and the listener's ability to leave all affect
...
legible. Motion without reference becomes a new state before it becomes a
relation.

Shape thresholds rather than continuous fuss. When does a slow beat become a
roughness? When does the fundamental lose priority to an upper partial? When
does active sustain become decay? When does a renewed sound cease to feel
continuous? Different listeners and rooms will place these thresholds
differently. Rehearsal is part of the composition.
...
event enters the physical decay or the memory left after it.
...
First, maintain it with continuous energy: one bow, breath-supported voice,
friction, or another genuinely sustained action.

Second, maintain it through renewal: repeated attacks, bow changes, breaths,
or exchanges whose seams may be shaped but not denied.

Third, stop active production and let sympathetic vibration, instrument body,
or room resonance carry what remains.

The order may be changed. The three conditions need not have equal length.
Keep the nominal identity stable enough that the form is heard in how it
...
Walk a few steps and a component strengthens. Wind changes. The pole and line
vibrate differently. Traffic masks one region of the spectrum and then passes.
The listener moves through a sound that was already moving internally.

A composer cannot reproduce that experience merely by lengthening a note. The
task is to choose which relations will remain available for entry: a beating
unison, a changing spectrum, a performer's renewal, a resonant body, a release
that leaves the room briefly holding the sound.
...
[^1]: Peter Dickinson's 1987 interview with La Monte Young records Young's
    memories of wind around the Idaho log cabin and continuous electrical
    sounds. “La Monte Young in Interview with Peter Dickinson, New York City,
    July 2, 1987,” in *CageTalk*,
    <https://resolve.cambridge.org/core/books/abs/cagetalk/la-monte-young-interview-with-peter-dickinson-new-york-city-july-2-1987/DFEAC6DE5F88A001120CD539F407F376>.
    These are autobiographical recollections, not independently reconstructable
    events.

[^2]: MELA Foundation's official biography documents Young's sustained-duration
    work, Theatre of Eternal Music, collaborations with Marian Zazeela, and
    twenty-six years of study with Pandit Pran Nath:
    <https://www.melafoundation.org/ly1para8.htm>. IRCAM provides a corroborating
    biography: <https://ressources.ircam.fr/en/composer/la-monte-young/biography>.
...
[^4]: William Moebs, Samuel J. Ling, and Jeff Sanny, “Beats,” *University
    Physics*, vol. 1, OpenStax, section 17.6,
    <https://openstax.org/books/university-physics-volume-1/pages/17-6-beats>;
    Wolfe, “Acoustics FAQ.” Both give the difference-frequency relation and
    its use in tuning.

[^5]: Wolfe, “Acoustics FAQ,” sections on interference beats, Tartini tones,
    and combination tones. The source distinguishes slow amplitude beating
    from an additional perceived or physically generated difference tone and
    emphasizes that source, ear, level, and context affect the result.

[^6]: Fondazione Isabella Scelsi, official catalogue entry for *Quattro pezzi
    per orchestra (ciascuno su una nota sola)*,
    <https://www.scelsi.it/it/quattro-pezzi-per-orchestra-%28ciascuno-su-una-nota-sola%29/>.
    The Foundation gives 1959, twenty-five performers, approximately fifteen
    minutes, Salabert, and a 1960 Paris premiere. IRCAM confirms the scoring
    and publisher but displays a conflicting creation date, which is not used
    here: <https://ressources.ircam.fr/en/works/work/11685>.

[^7]: Gregory Reish, “Una Nota Sola: Giacinto Scelsi and the Genesis of Music
    on a Single Note,” *Journal of Musicological Research* 25, no. 2 (2006),
    <https://www.tandfonline.com/doi/abs/10.1080/01411890600613827>; Fondazione
...
[^8]: Museum of Modern Art, “Collecting Alvin Lucier's *I Am Sitting in a
    Room*,” January 20, 2015,
    <https://www.moma.org/explore/inside_out/2015/01/20/collecting-alvin-luciers-i-am-sitting-in-a-room/>;
    Matthieu Saladin, “Survey of Works by Alvin Lucier,” IRCAM,
    <https://brahms.ircam.fr/en/composer/alvin-lucier/workcourse>. MoMA gives the
    1969 first performance and documents the repeated voice-and-room process.

[^9]: Lucier's score-text states his wish to smooth irregularities in his
