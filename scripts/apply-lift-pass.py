...
LIFT_SENTENCES = {
    ...
    125: "Compose that attentiveness well, and relationships can produce detail no individual part could contain.",
    126: "Named capacity turns openness from abdication into collaboration.",
    127: "Following that chain can enlarge authorship without allowing anyone's contribution to vanish.",
    128: "When risk and recognition are visible, performers can offer more of their judgment without being asked to disappear into the result.",
    129: "Once those distributions are audible, they can be revised, and the ensemble can discover forms of leadership the composer could not assign in advance.",
    130: "Designing a way back gives performers permission to take risks that a brittle form would punish.",
    131: "Clear ownership makes freedom usable: each open decision can carry actual consequence instead of decorative uncertainty.",
    132: "The family succeeds when its members remain recognizably related and genuinely capable of surprising one another.",
    133: "Each revision can move freedom closer to the knowledge that makes it musically alive.",
    134: "As responsibility widens beyond the ensemble, the surrounding world becomes capable of changing the piece in turn.",
    135: "Writing those conditions into the work can make place an active collaborator without pretending it is a neutral instrument.",
    136: "Once a local event can alter a decision, every performance gains a way to discover where it actually is.",
    137: "Leave the room that work, and architecture can become a temporal voice rather than an added effect.",
    138: "That precision makes portability and specificity available as choices, not opposing virtues.",
    139: "Accurate naming can deepen a work's relation to place because it replaces borrowed atmosphere with actual history.",
    140: "Compose those differences, and movement can reveal a piece no fixed seat could contain.",
    141: "A function can give music more ways to matter, not fewer.",
    142: "Answering that question turns atmosphere from a finish applied to the music into a relation the music can change.",
    143: "A site-shaped origin can remain generative elsewhere, carrying questions that each new room must answer differently.",
    144: "When the world refuses the premise, the piece has an opportunity to become more situated rather than less itself.",
    145: "Care at that scale can make public music more adventurous, because its pressure no longer depends on unchosen captivity.",
    146: "Consequence gives atmosphere direction: the music can support, expose, interrupt, or make room.",
    147: "Composing that return lets the ending give the place back changed in attention, if not in fact.",
    148: "That outside hearing may reveal a formal condition no rehearsal inside the ensemble could detect.",
    149: "The room's return offers one clue: an ending can release a world whose continuation the piece has taught us to hear.",
    150: "That definition gives every continuation a task and every ending something precise to answer.",
    151: "Choose the verbs clearly, and even a spare diagram can begin to generate dramatic consequence.",
    152: "When the reason changes, continuation stops being mere extension and becomes discovery.",
    153: "A strong opening creates possibility by making later difference consequential.",
    154: "Find that place, and a small alteration can move the whole form farther than a page of new material.",
    155: "Once the clocks can be distinguished, their rare agreements can carry enormous weight.",
    156: "A modest answer is enough to renew a state and give continuation fresh purpose.",
    157: "That capacity for contradiction lets a procedure discover an ending rather than merely arrive at one.",
    158: "Selecting the necessary threshold can give a short form completeness and a long form room to breathe.",
    159: "Finding that scale lets aftersound continue the form without asking it to impersonate eternity.",
    160: "Name the verb, and the ending becomes a consequence rather than a stop sign.",
    161: "Within that limit lies a generous possibility: the work can shape its departure without occupying everything that follows.",
    162: "That backward change is the ending's creative power: it lets the final decision reorganize everything already heard.",
    163: "The interval may contain the most honest ending available: the moment control loosens and listening continues.",
    164: "A relation worth continuing is not an unfinished ending. It is the space in which another decision can become necessary.",
}
